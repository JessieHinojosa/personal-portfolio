module.exports = {
  ...
  theme: { 
   ...
   boxShadow: {
    ...
    DEFAULT: '0 1px 3px 0 rgba(253,253,253, 1), 0 1px 2px 0 rgba(0, 0, 0, 0.06)',
    md: '0 4px 6px -1px rgba(253,253,253, 1), 0 2px 4px -1px rgba(0, 0, 0, 0.06)',
    lg: '5px 5px 10px -3px rgba(253,253,253, .5), 0 4px 6px -2px rgba(0, 0, 0, 0.05)',
   ...
   borderRadius: {
    ...
    extend: {
      ...
      spacing:{
        ...
        'mobile-lg-bg-paper-top-position': '260rem',
        "desktop-w": '32rem',
        ...
        'desktop-bg-bottomConnectWeb-top': '295rem',
        'desktop-bg-paper-top-position': '350rem',
